...
import (
	...
	generate "github.com/Yogeshlodhi/Tokens"
...
func Signup() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if inserterr != nil{
			c.JSON(http.StatusInternalServerError, gin.H{"error": "the user did not get creaated"})
			return
		}
		defer cancel()
...
func SearchProduct() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		if err != nil{
			c.IndentedJSON(http.StatusInternalServerError, "Something went wrong, pleaase try after some time")
			return
		}
